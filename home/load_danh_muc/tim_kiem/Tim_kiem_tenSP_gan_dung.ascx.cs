...
{
    public partial class Tim_kiem_tenSP_gan_dung : System.Web.UI.UserControl
    {
        xl_dl.data_Home.san_pham data_sp = new xl_dl.data_Home.san_pham();
        protected void Page_Load(object sender, EventArgs e)
        {
            DataTable tb = new DataTable();
            tb = data_sp.tim_kiem_theo_tenDanhMuc(laytensp());
        ...
        public string laytensp()
        {
            ...
            {
                return Request.QueryString["tensp"].ToString().Trim();
            }
            return null;
        }
    }
